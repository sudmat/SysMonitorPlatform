"""
This script is called by the plugin-wrapper, ModelChecker.js, which passes down the
...
plugin = ModelChecker(webgme, COMMIT_HASH, BRANCH_NAME, ACTIVE_NODE_PATH, ACTIVE_SELECTION_PATHS, NAMESPACE)
